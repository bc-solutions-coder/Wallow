...
## Purpose
Foundry is a **production-ready .NET modular monolith base platform** with multi-tenancy support. It demonstrates Clean Architecture, DDD, CQRS, and message-based communication in a commercially viable foundation that teams can fork and extend.
...
## Key Documentation
- Design document: `docs/plans/2026-02-04-foundry-pivot-design.md`
