...
## [2.0.0](https://github.com/bc-solutions-coder/wallow/compare/v1.0.1...v2.0.0) (2026-03-29)
...
* add database migration init container with EF Core bundles ([816a540](https://github.com/bc-solutions-coder/wallow/commit/816a540b328ab0e3e09b3c51e98d60f61a0c3a08))
...
* add notifications, inquiries, and billing enhancements ([f3d09c6](https://github.com/bc-solutions-coder/wallow/commit/f3d09c640f811e1b4fa0a697dc07981434abade4))
...
* add repo promotion assets, GitHub Pages deploy, SEO meta tags, and Why Wallow README section ([#11](https://github.com/bc-solutions-coder/wallow/issues/11)) ([925c15c](https://github.com/bc-solutions-coder/wallow/commit/925c15cd91dfda43dbbae639ff3597452266864a))
...
* **api:** add CSRF protection with antiforgery middleware and explicit controller postures ([cbfa29c](https://github.com/bc-solutions-coder/wallow/commit/cbfa29ca32c74597123f1f7bcef0bdfd7e7224f9))
...
* **docs:** add DocFX docs site with branding-driven theme ([3bb254d](https://github.com/bc-solutions-coder/wallow/commit/3bb254da1a4d586099af8eef2ed2ae492c487026))
...
* **identity:** add OpenIddict auth, MFA, passwordless login, and Blazor apps ([3d95cf9](https://github.com/bc-solutions-coder/wallow/commit/3d95cf99f0328486d587867cd3aab8cecfa4756b))
...
* **identity:** implement MFA overhaul with partial-auth sessions ([0791fbc](https://github.com/bc-solutions-coder/wallow/commit/0791fbcbcf3e234bca03b9d8e7a11c0a2841552a))
...
* **realtime:** add SSE infrastructure with audience-scoped filtering ([212aca9](https://github.com/bc-solutions-coder/wallow/commit/212aca967384ffce0bf86be0715fbb7f90ef0b00))
...
* **storage:** begin optional ClamAV with design and config refactor ([4fe0cff](https://github.com/bc-solutions-coder/wallow/commit/4fe0cfff89c1cd1487cc982c57a29e5d934d720d))
...
* add proper health checks to Auth/Web apps and fix docker healthcheck URLs ([85487e4](https://github.com/bc-solutions-coder/wallow/commit/85487e4cbecab0b1b5231e8e478fd0de593051f2))
...
* **auth:** prevent open-redirect via ReturnUrl in Blazor pages ([#13](https://github.com/bc-solutions-coder/wallow/issues/13)) ([f5b75f9](https://github.com/bc-solutions-coder/wallow/commit/f5b75f9e08083ab3393706750343fbc226962c4b))
...
* **e2e:** improve Blazor login reliability with circuit-aware waits ([3edbda2](https://github.com/bc-solutions-coder/wallow/commit/3edbda21f138ef8c0f47cf0824b06e02f662f6a4))
* exclude only docs/plans instead of entire docs directory in .dockerignore ([#9](https://github.com/bc-solutions-coder/wallow/issues/9)) ([b77597c](https://github.com/bc-solutions-coder/wallow/commit/b77597ca9220ec696740473207e244c5f4e7ce9d))
