# Foundry Platform Improvements — Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Fix critical infrastructure gaps, add SMS/Inbox channels, establish config-driven module toggles, and clean up scaffold confusion — making Foundry fork-ready as a generic SaaS platform base.
...
**Files:**
- Create: `src/Shared/Foundry.Shared.Kernel/MultiTenancy/ITenantContextSetter.cs`
- Modify: `src/Shared/Foundry.Shared.Kernel/MultiTenancy/TenantContext.cs`
...
**Files:**
- Modify: `src/Foundry.Api/Middleware/TenantResolutionMiddleware.cs` (or wherever it lives)
...
**Files:**
- Create: `src/Shared/Foundry.Shared.Kernel/Messaging/TenantStampingMiddleware.cs`
...
namespace Foundry.Shared.Kernel.Messaging;
...
**Files:**
- Create: `src/Shared/Foundry.Shared.Kernel/Messaging/TenantRestoringMiddleware.cs`
...
**Files:**
- Modify: `src/Foundry.Api/Program.cs` (Wolverine configuration section)
...
**Files:**
- Create: `tests/Foundry.Architecture.Tests/Messaging/TenantStampingMiddlewareTests.cs`
- Create: `tests/Foundry.Architecture.Tests/Messaging/TenantRestoringMiddlewareTests.cs`
...
**Files:**
- Create: `src/Shared/Foundry.Shared.Kernel/MultiTenancy/TenantAwareDbContext.cs`
...
**Files:**
- Modify: `src/Modules/Billing/Foundry.Billing.Infrastructure/Persistence/BillingDbContext.cs`
...
**Files:**
- Modify: `src/Modules/Configuration/Foundry.Configuration.Infrastructure/Persistence/ConfigurationDbContext.cs`
...
**Files:**
- Create: `tests/Foundry.Architecture.Tests/MultiTenancy/TenantAwareDbContextTests.cs`
...
**Steps:**
1. Add `Foundry:Modules` section with all 5 current modules defaulting to `true`
...
#### Task 1.3.2: Update FoundryModules.cs to read configuration

**Files:**
- Modify: `src/Foundry.Api/FoundryModules.cs`

**Steps:**
1. Read `Foundry:Modules` section
2. Conditionally register each module based on config value (default: true)
3. Same for `InitializeFoundryModulesAsync`
...
**Files:**
- Create: `tests/Foundry.Architecture.Tests/Modules/ModuleToggleTests.cs`
...
**Steps:**
1. Remove project references from `Foundry.sln`
2. Remove project references from `Foundry.Api.csproj` if any
...
**Files:**
- Modify: `tests/Foundry.Architecture.Tests/TestConstants.cs`

**Steps:**
1. Replace hardcoded array with reflection-based discovery scanning for `Foundry.*.Domain` assemblies
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Infrastructure/BackgroundJobs/RetryFailedEmailsJob.cs`
...
**Files:**
- Create or Modify: `src/Modules/Communications/Foundry.Communications.Infrastructure/BackgroundJobs/CommunicationsRecurringJobs.cs`
...
**Files:**
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Infrastructure/RetryFailedEmailsJobTests.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Application/Channels/Email/Interfaces/IEmailProvider.cs`
...
**Files:**
- Modify: `src/Modules/Communications/Foundry.Communications.Infrastructure/Services/SmtpEmailService.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Infrastructure/Services/EmailProviderAdapter.cs`
...
**Files:**
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Infrastructure/SmtpEmailProviderTests.cs`
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Infrastructure/EmailProviderAdapterTests.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Channels/Sms/ValueObjects/PhoneNumber.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Channels/Sms/Identity/SmsMessageId.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Channels/Sms/Enums/SmsStatus.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Channels/Sms/Entities/SmsMessage.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Channels/Sms/Events/SmsSentDomainEvent.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Channels/Sms/Events/SmsFailedDomainEvent.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Channels/Sms/Identity/SmsPreferenceId.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Channels/Sms/Entities/SmsPreference.cs`
...
**Files:**
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Domain/Channels/Sms/PhoneNumberTests.cs`
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Domain/Channels/Sms/SmsMessageTests.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Application/Channels/Sms/Interfaces/ISmsProvider.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Application/Channels/Sms/Interfaces/ISmsMessageRepository.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Application/Channels/Sms/Commands/SendSms/SendSmsCommand.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Application/Channels/Sms/Commands/SendSms/SendSmsHandler.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Application/Channels/Sms/Commands/SendSms/SendSmsValidator.cs`
...
**Files:**
- Create: `src/Shared/Foundry.Shared.Contracts/Communications/Sms/Events/SendSmsRequestedEvent.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Application/Channels/Sms/EventHandlers/SendSmsRequestedEventHandler.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Infrastructure/Services/NullSmsProvider.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Infrastructure/Services/TwilioSmsProvider.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Infrastructure/Services/TwilioSettings.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Infrastructure/Persistence/Configurations/SmsMessageConfiguration.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Infrastructure/Persistence/Configurations/SmsPreferenceConfiguration.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Infrastructure/Persistence/Repositories/SmsMessageRepository.cs`
...
2. Create EF migration: `dotnet ef migrations add AddSmsChannel --project src/Modules/Communications/Foundry.Communications.Infrastructure --startup-project src/Foundry.Api --context CommunicationsDbContext`
...
**Files:**
- Modify: `src/Modules/Communications/Foundry.Communications.Infrastructure/Extensions/InfrastructureExtensions.cs`
...
**Files:**
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Application/Channels/Sms/SendSmsHandlerTests.cs`
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Application/Channels/Sms/SendSmsValidatorTests.cs`
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Application/Channels/Sms/SendSmsRequestedEventHandlerTests.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Domain/NotificationTypes.cs`
...
```csharp
namespace Foundry.Communications.Domain;
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Preferences/Identity/ChannelPreferenceId.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Preferences/Enums/ChannelType.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Preferences/Entities/ChannelPreference.cs`
...
**Files:**
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Domain/Preferences/ChannelPreferenceTests.cs`
...
**Files:**
- Modify: `src/Modules/Communications/Foundry.Communications.Domain/Channels/InApp/Entities/Notification.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Application/Channels/InApp/Commands/ArchiveNotification/ArchiveNotificationCommand.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Application/Channels/InApp/Commands/ArchiveNotification/ArchiveNotificationHandler.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Messaging/Identity/ConversationId.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Messaging/Identity/MessageId.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Messaging/Identity/ParticipantId.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Messaging/Enums/ConversationStatus.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Messaging/Enums/MessageStatus.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Messaging/Entities/Participant.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Messaging/Entities/Message.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Messaging/Entities/Conversation.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Messaging/Events/MessageSentDomainEvent.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Messaging/Events/ConversationCreatedDomainEvent.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Domain/Messaging/Events/ParticipantAddedDomainEvent.cs`
...
**Files:**
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Domain/Messaging/ConversationTests.cs`
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Domain/Messaging/MessageTests.cs`
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Domain/Messaging/ParticipantTests.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/Interfaces/IConversationRepository.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/Commands/CreateConversation/CreateConversationCommand.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/Commands/CreateConversation/CreateConversationHandler.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/Commands/CreateConversation/CreateConversationValidator.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/Commands/SendMessage/SendMessageCommand.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/Commands/SendMessage/SendMessageHandler.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/Commands/SendMessage/SendMessageValidator.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/Commands/MarkConversationRead/MarkConversationReadCommand.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/Commands/MarkConversationRead/MarkConversationReadHandler.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/Queries/GetConversations/GetConversationsQuery.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/Queries/GetConversations/GetConversationsHandler.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/Queries/GetMessages/GetMessagesQuery.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/Queries/GetMessages/GetMessagesHandler.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/Queries/GetUnreadConversationCount/GetUnreadConversationCountQuery.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/Queries/GetUnreadConversationCount/GetUnreadConversationCountHandler.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/EventHandlers/MessageSentEventHandler.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/DTOs/ConversationDto.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/DTOs/MessageDto.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Application/Messaging/DTOs/ParticipantDto.cs`
...
**Files:**
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Application/Messaging/CreateConversationHandlerTests.cs`
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Application/Messaging/SendMessageHandlerTests.cs`
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Application/Messaging/MarkConversationReadHandlerTests.cs`
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Application/Messaging/MessageSentEventHandlerTests.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Infrastructure/Persistence/Configurations/ConversationConfiguration.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Infrastructure/Persistence/Configurations/MessageConfiguration.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Infrastructure/Persistence/Configurations/ParticipantConfiguration.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Infrastructure/Persistence/Repositories/ConversationRepository.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Api/Controllers/ConversationsController.cs`
...
**Files:**
- Create: `src/Modules/Communications/Foundry.Communications.Api/Contracts/Messaging/CreateConversationRequest.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Api/Contracts/Messaging/SendMessageRequest.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Api/Contracts/Messaging/ConversationResponse.cs`
- Create: `src/Modules/Communications/Foundry.Communications.Api/Contracts/Messaging/MessageResponse.cs`
...
**Files:**
- Create: `src/Shared/Foundry.Shared.Contracts/Communications/Messaging/Events/MessageSentEvent.cs`
- Create: `src/Shared/Foundry.Shared.Contracts/Communications/Messaging/Events/ConversationCreatedEvent.cs`
...
**Files:**
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Integration/Messaging/ConversationIntegrationTests.cs`
...
**Files:**
- Create: `tests/Modules/Communications/Foundry.Communications.Tests/Integration/Sms/SmsIntegrationTests.cs`
...
**Files:**
- Create: `tests/Foundry.Tests.Common/Builders/ConversationBuilder.cs`
- Create: `tests/Foundry.Tests.Common/Builders/SmsMessageBuilder.cs`
- Create: `tests/Foundry.Tests.Common/Builders/NotificationBuilder.cs`
