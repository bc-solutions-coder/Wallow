...
public sealed class ValkeyMeteringService : IMeteringService
{
    ...
    public async Task IncrementAsync(string meterCode, decimal value = 1, Dictionary<string, string>? dimensions = null)
    {
        ...
        // Set expiry to 90 days to prevent unbounded growth
        await db.KeyExpireAsync(key, _keyExpiration, ExpireWhen.HasNoExpiry);
    }
    ...
    private static string GetCurrentPeriodKey(QuotaPeriod period)
    {
        ...
        return period switch
        {
            ...
            QuotaPeriod.Monthly => now.ToString("yyyy-MM"),
