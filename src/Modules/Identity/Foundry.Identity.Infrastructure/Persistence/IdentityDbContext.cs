...
using AspNetIdentityDbContext = Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityDbContext<
    Foundry.Identity.Domain.Entities.FoundryUser,
    Foundry.Identity.Domain.Entities.FoundryRole,
    System.Guid>;
...
#pragma warning restore SA1401, CA1051, IDE1006, IDE0052
    ...
    {
        modelBuilder.Entity<FoundryUser>(b =>
        {
            b.ToTable("users");
        ...
        modelBuilder.Entity<FoundryRole>(b =>
        {
            b.ToTable("roles");
