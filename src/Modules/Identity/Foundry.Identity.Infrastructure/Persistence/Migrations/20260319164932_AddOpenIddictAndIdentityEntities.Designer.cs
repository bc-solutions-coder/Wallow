...
namespace Foundry.Identity.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260319164932_AddOpenIddictAndIdentityEntities")]
    partial class AddOpenIddictAndIdentityEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foundry.Identity.Domain.Entities.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Foundry.Identity.Domain.Entities.FoundryRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Foundry.Identity.Domain.Entities.FoundryUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Foundry.Identity.Domain.Entities.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Foundry.Identity.Domain.Entities.OrganizationMember", b =>
                {
            ...
            modelBuilder.Entity("Foundry.Identity.Domain.Entities.OrganizationMember", b =>
                {
                    b.HasOne("Foundry.Identity.Domain.Entities.Organization", null)
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Foundry.Identity.Domain.Entities.FoundryRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Foundry.Identity.Domain.Entities.FoundryUser", null)
                        .WithMany()
