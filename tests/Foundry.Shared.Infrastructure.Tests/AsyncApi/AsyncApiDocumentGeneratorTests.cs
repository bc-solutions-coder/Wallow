...
public class AsyncApiDocumentGeneratorTests
{
    ...
    private static EventFlowInfo CreateFlow(
        ...
        new(
            ...
            ExchangeName: $"Foundry.Shared.Contracts.{sourceModule}.{eventType.Name}",
            Consumers: consumers ?? [],
            SagaTrigger: false);
    ...
    public void GenerateDocument_HasInfoBlock()
    {
        ...
        info["title"]!.GetValue<string>().Should().Be("Foundry Event Catalog");
    ...
    public void GenerateDocument_ChannelHasCorrectAddress()
    {
        ...
        channel["address"]!.GetValue<string>().Should().Be("Foundry.Shared.Contracts.Sales.TestOrderPlaced");
    }
