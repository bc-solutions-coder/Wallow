...
public class HangfireJobSchedulerTests
{
    ...
    [Fact]
    public void AddFoundryBackgroundJobs_Registers_IJobScheduler_As_HangfireJobScheduler()
    {
    ...
    [Fact]
    public void AddFoundryBackgroundJobs_Registers_As_Singleton()
    {
        ServiceCollection services = new();
    ...
    [Fact]
    public void AddFoundryBackgroundJobs_Returns_Same_Instance_Across_Scopes()
    {
        ServiceCollection services = new();
        services.AddFoundryBackgroundJobs();
        ServiceProvider provider = services.BuildServiceProvider();
