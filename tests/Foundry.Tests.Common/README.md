# Foundry.Tests.Common

Shared test infrastructure for Foundry integration tests.
...
- **FoundryApiFactory**: Combines all containers + WebApplicationFactory
...
Jwt:Issuer = "Foundry.Test"
Jwt:Audience = "Foundry.Test.Client"
