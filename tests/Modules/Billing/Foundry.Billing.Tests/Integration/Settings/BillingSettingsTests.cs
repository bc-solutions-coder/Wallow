...
namespace Foundry.Billing.Tests.Integration.Settings;

[CollectionDefinition(nameof(BillingSettingsTestCollection))]
public class BillingSettingsTestCollection : ICollectionFixture<FoundryApiFactory>;

[Collection(nameof(BillingSettingsTestCollection))]
[Trait("Category", "Integration")]
public sealed class BillingSettingsTests(FoundryApiFactory factory) : FoundryIntegrationTestBase(factory)
{
