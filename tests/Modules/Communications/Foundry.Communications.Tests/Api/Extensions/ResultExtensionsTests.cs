...
namespace Foundry.Communications.Tests.Api.Extensions;
...
public class ResultExtensionsTests
{
    ...
    {
        Result result = Result.Failure(Error.NotFound("Entity", "123"));
    ...
    {
        Result result = Result.Failure(Error.NotFound("Notification", "test"));
        ...
        problem.Extensions["code"].Should().Be("Notification.NotFound");
    }
    ...
    public void ToCreatedResult_WhenSuccess_ReturnsCreatedResult()
    {
        ...
        IActionResult actionResult = result.ToCreatedResult("/api/items/1");
    ...
    [Fact]
    public void ToNoContentResult_WhenNotFoundError_Returns404()
    {
        Result result = Result.Failure(Error.NotFound("Entity", "123"));
    ...
    [Fact]
    public void ToNoContentResult_WhenValidationError_Returns400()
    {
        Result result = Result.Failure(Error.Validation("Bad request"));
