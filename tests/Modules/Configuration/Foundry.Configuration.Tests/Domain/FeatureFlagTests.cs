...
public class FeatureFlagCreateBooleanTests
{
    ...
    {
        FeatureFlag flag = FeatureFlag.CreateBoolean("beta_feature", "Beta Feature", false);
    ...
    {
        FeatureFlag flag1 = FeatureFlag.CreateBoolean("key1", "Flag 1", true);
        FeatureFlag flag2 = FeatureFlag.CreateBoolean("key2", "Flag 2", true);
...
public class FeatureFlagCreatePercentageTests
{
    ...
    {
        FeatureFlag flag = FeatureFlag.CreatePercentage("rollout", "Gradual Rollout", 50, "50% rollout");
    ...
    {
        FeatureFlag flag = FeatureFlag.CreatePercentage("rollout", "Rollout", 0);
    ...
    {
        FeatureFlag flag = FeatureFlag.CreatePercentage("rollout", "Rollout", 100);
    ...
    {
        Action act = () => FeatureFlag.CreatePercentage("rollout", "Rollout", percentage);
...
public class FeatureFlagCreateVariantTests
{
    ...
    public void CreateVariant_WithValidVariants_ReturnsVariantFlag()
    {
        ...
        FeatureFlag flag = FeatureFlag.CreateVariant("ab_test", "A/B Test", variants, "control", "Test description");
    ...
    public void CreateVariant_WithEmptyVariants_ThrowsArgumentException()
    {
        ...
        Action act = () => FeatureFlag.CreateVariant("ab_test", "A/B Test", variants, "control");
    ...
    public void CreateVariant_WithDefaultNotInList_ThrowsArgumentException()
    {
        ...
        Action act = () => FeatureFlag.CreateVariant("ab_test", "A/B Test", variants, "missing");
...
public class FeatureFlagUpdateTests
{
    ...
    public void Update_WithNewValues_ChangesNameDescriptionAndEnabled()
    {
        ...
        flag.Update("Updated", "New description", false);
...
public class FeatureFlagUpdatePercentageTests
{
    ...
    {
        FeatureFlag flag = FeatureFlag.CreatePercentage("rollout", "Rollout", 25);

        flag.UpdatePercentage(75);
    ...
    {
        FeatureFlag flag = FeatureFlag.CreateBoolean("key", "Boolean Flag", true);

        Action act = () => flag.UpdatePercentage(50);
    ...
    public void UpdatePercentage_WithInvalidValue_ThrowsArgumentOutOfRange(int percentage)
    {
        ...
        Action act = () => flag.UpdatePercentage(percentage);
...
public class FeatureFlagSetVariantsTests
{
    ...
    public void SetVariants_OnVariantFlag_ReplacesVariants()
    {
        ...
        FeatureFlag flag = FeatureFlag.CreateVariant("ab_test", "Test", original, "control");
    ...
    public void SetVariants_WithoutCurrentDefault_ThrowsArgumentException()
    {
        ...
        Action act = () => flag.SetVariants(updated);
    ...
    {
        FeatureFlag flag = FeatureFlag.CreateBoolean("key", "Boolean", true);

        Action act = () => flag.SetVariants([new VariantWeight("v1", 100)]);
