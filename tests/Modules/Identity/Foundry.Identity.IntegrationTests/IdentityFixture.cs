...
{
    public const string TestUserEmail = "testuser@foundry.dev";
    ...
    public const string ApiClientId = "foundry-api";
    public const string ApiClientSecret = "foundry-api-secret";
    ...
    {
        UserManager<FoundryUser> userManager = services.GetRequiredService<UserManager<FoundryUser>>();

        FoundryUser? existing = await userManager.FindByEmailAsync(TestUserEmail);
    ...
    private static async Task SeedClientsAsync(IServiceProvider services)
    {
        ...
        await EnsureClientAsync(appManager, ApiClientId, ApiClientSecret, "Foundry API");
