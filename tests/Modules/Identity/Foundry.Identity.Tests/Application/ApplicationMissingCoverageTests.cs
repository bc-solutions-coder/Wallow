...
namespace Foundry.Identity.Tests.Application;
...
public class ApplicationMissingCoverageTests
{
    ...
    public void SsoConfigurationDto_AllPropertiesAccessible()
    {
        ...
        SsoConfigurationDto dto = new(
            ...
            ServiceProviderEntityId: "https://foundry.example.com",
            ServiceProviderAcsUrl: "https://foundry.example.com/saml/acs",
            ServiceProviderMetadataUrl: "https://foundry.example.com/saml/metadata");
    ...
    public void ApiKeyMetadata_WithExpiresAt_IsAccessible()
    {
        ...
        Foundry.Identity.Application.Interfaces.ApiKeyMetadata metadata = new(
            KeyId: "key-id-123",
            Name: "My API Key",
            Prefix: "sk-key-i",
            UserId: userId,
